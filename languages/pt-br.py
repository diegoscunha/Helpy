...
'Atende chamados?': 'Atende chamados?',
'Available Databases and Tables': 'Bancos de dados e tabelas disponíveis',
'Back': 'Voltar',
'Buy this book': 'Compre o livro',
"Buy web2py's book": "Compre o livro web2py's",
'cache': 'cache',
'Cache': 'Cache',
...
'Close': 'Fechar',
'Cnpj': 'Cnpj',
'Codigo de ativação': 'Codigo de ativação',
'Codigo de liberação': 'Codigo de liberação',
...
'design': 'projeto',
'Design': 'Design',
'Dias liberação': 'Dias liberação',
'Digite uma data válida!': 'Digite uma data válida!',
'DISK': 'DISK',
...
'in': 'in',
'Index': 'Início',
'Informe no maxímo 20 caracteres!': 'Informe no maxímo 20 caracteres!',
...
'login': 'Entrar',
'Login': 'Autentique-se',
'Login ou senha inválidos': 'Login ou senha inválidos',
'logout': 'Sair',
...
'O código deve possuir 45 caracteres!': 'O código deve possuir 45 caracteres!',
...
'É administrador?': 'É administrador?',
}
